$(document).ready(function() {
    ...
    !function(t) {
        ...
        r._beforeUpdate = null, r._afterUpdate = null, r._rows = n, r._parse = i, r._parseOptions = a, 
            ...
            return d.each(function() {
                ...
                if (s.target) a = s.target.outerHeight(!1); else {
                    ...
                    n.each(function() {
                        ...
                        i[s.property] = "", e.css(i), e.outerHeight(!1) > a && (a = e.outerHeight(!1)), 
                        e.css("display", "");
                    });
                }
                n.each(function() {
                    ...
                    o += i(e.css("padding-top")) + i(e.css("padding-bottom"))), e.css(s.property, a - o + "px"));
                });
            }), d.each(function() {
                var e = t(this);
    ...
    $("#mobile-menu-foldout-toggle").on("click", function() {
        $("#mobile-menu-foldout").toggleClass("hide");
    });
    $("#mobile-study").on("click", function() {
        $("#mobile-menu-foldout").toggleClass("hide");
    });
    $("#study").on("click", function() {
        $("#overlay-menu").toggleClass("hide");
        $("#study-menu").toggleClass("hide");
    });
});